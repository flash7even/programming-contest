...
/// Given some points find the closest pair of them
/// Call closestPairOfPoints()
...
Point xList[25][Size][2];
Point yList[25][Size][2];
Point strip[Size];
...
/// Returns an RET object which store the index of the closest 2 points
